...
Here are some examples of how you can use the `displaced` package. The `population` dataset can be used to easily get data on forced displacement or statelessness.
...
The `population` dataset can be used to get the 10 countries of origin with highest number of refugees, people in refugee-like situations including people in need of internation protection in 2022.
...
```
 ...
 We can use `ggplot2` and the [`unhcrthemes`](https://github.com/vidonne/unhcrthemes) to visualize our data while following the [UNHCR data visualization guidelines](https://dataviz.unhcr.org/general_guidance/).
...
This package is released under the [Creative Commons Attribution for Intergovernmental Organisations](https://creativecommons.org/licenses/by/3.0/igo/)
