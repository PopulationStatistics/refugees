...
We can use `ggplot2` and the [`unhcrthemes`](https://github.com/vidonne/unhcrthemes) to visualize our data following the [UNHCR data visualization guidelines](https://dataviz.unhcr.org/general_guidance/).
